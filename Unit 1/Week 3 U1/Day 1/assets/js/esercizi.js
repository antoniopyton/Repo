...
const changePcontent = function () {
    ...
    for (let i = 0; i < selettore.length; i++) {
        selettore[i].innerText = 'Questo testo è stato cambiato'
    }
...
const addToTheSecond = function () {
    ...
    secondList.innerHTML += "<li>Testo aggiuntivo</li>"
}
addToTheSecond()
/* ESERCIZIO 6
...
const addParagraph = function () {
    ...
    p.innerText = 'Ciao sono un paragrafo';
    div.appendChild(p);
...
/*const makeItClickable = function () { 
    ...
    h1.addEventListener('click', function(e)) {
        e.preventDefault();
        let text = document.getElementsByTagName('h1')[0].textContent; 
