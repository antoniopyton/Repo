...
const primoProdotto = {
    ...
    "imageUrl": "https://m.media-amazon.com/images/I/81eBCzFo3oL._SY466_.jpg"
}
...
internoCard = (element, col) => {
    ...
    <div class="card-body">
      <a href="modifica.html?id=${element._id}"><button id="modifica" class="btn btn-outline-warning" type="">Modifica</button></a>
      <a href="scopri-di-piu.html?id=${element._id}"><button id="info" class="btn btn-outline-info" type="">Scopri di più</button></a>
    </div>
  </div> `
  riga.append(col)
}
