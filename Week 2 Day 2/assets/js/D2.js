...
if (num1 > num2) {
  numeroMaggiore = num1 + ' è maggiore';

} else (num1 < num2)
{
  numeroMaggiore = num2 + ' è maggiore';
}
...
if (totalShoppingCart < 50) {
  spedizione = "La spedizione ha un costo fisso di 10€";
...
if(prezzoScontato > 50) {
  console.log('con lo sconto la spedizione è gratuita, quindi utente spende' + prezzoScontato )
} else {
  console.log('con lo sconto la spedizione non è gratuita, quindi l utente spende' + (prezzoScontato + 10) )
}
